 ...
 */
router.get('/recent', authenticate, async (req: CustomRequest, res: Response) => {
 ...
 * @access Private
 */
router.get('/classes/:classId/assignments', authenticate, async (req: CustomRequest, res: Response) => {
 ...
 * @access Private
 */
router.get('/classes/:classId/subjects/:subjectId/assignments', authenticate, async (req: CustomRequest, res: Response) => {
 ...
 * @access Private (Teachers only)
 */
router.post('/classes/:classId/subjects/:subjectId/assignments', authenticate, async (req: CustomRequest, res: Response) => {
